...
namespace EventFlow.Events.Infrastructure.Migrations
{
    ...
    [Migration("20250208190324_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventFlow.Events.Domain.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventFlow.Events.Domain.Events.Entities.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventFlow.Events.Domain.TicketTypes.TicketType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("EventFlow.Events.Domain.Events.Entities.Event", b =>
                {
                    b.HasOne("EventFlow.Events.Domain.Categories.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventFlow.Events.Domain.TicketTypes.TicketType", b =>
                {
                    b.HasOne("EventFlow.Events.Domain.Events.Entities.Event", null)
                        .WithMany()
